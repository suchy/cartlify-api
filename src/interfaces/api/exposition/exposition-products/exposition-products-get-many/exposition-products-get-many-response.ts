...
export type ExpositionProductsGetManyResponseFactory = (params: {
...
export const ExpositionProductsGetManyResponseFactory: ExpositionProductsGetManyResponseFactory = ({
  fields,
  products,
  productsCount,
  productsPerPage
